...
function getBatchPurchasePendingApprovals(roleCodes, options = {}) {
  ...
  let sql = `
    ...
    INNER JOIN batch_purchase_approvals ba ON bp.id = ba.batch_purchase_id
      AND ba.action IS NULL
